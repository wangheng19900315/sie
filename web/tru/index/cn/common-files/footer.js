...
document.writeln("					<p class=\'mt10\'>电话：（010）400 666 5576</p>");
document.writeln("					<p>邮箱：iss@ied.ecnu.edu.cn</p>");
document.writeln("					<p>微信：truabroad</p>");
document.writeln("				</div>");
document.writeln("			</li>");
document.writeln("			<li class=\'col-xs-3\'>");
...
document.writeln("			<span>Copyright © 2018 Thompson International Education Group Limited</span>");
document.writeln("			<span>京ICP备17068993号</span>");
document.writeln("		</p>");
document.writeln("	</div>");
document.writeln("</div>");
document.writeln("");
