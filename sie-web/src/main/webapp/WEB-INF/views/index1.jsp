...
<head>
	...
	<!--[if lt IE 9]>
		<script src="/statics/assets/javascripts/ie.min.js"></script>
	<![endif]-->
</head>
							...
							<li class="nav-icon-btn nav-icon-btn-success dropdown">
								...
								<div class="dropdown-menu widget-messages-alt no-padding" style="width: 300px;">
									<div class="messages-list" id="main-navbar-messages">
										...
										<div class="message">
											<img src="/statics/assets/demo/avatars/2.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="/statics/assets/demo/avatars/3.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="/statics/assets/demo/avatars/4.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="/statics/assets/demo/avatars/5.jpg" alt="" class="message-avatar">
											<a href="#" class="message-subject">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
											<div class="message-description">
				...
				<div class="panel panel-warning" id="dashboard-recent">
					...
					<div class="tab-content">
						...
						<div class="widget-comments panel-body tab-pane no-padding fade active in" id="dashboard-recent-comments">
							...
							<div class="panel-padding no-padding-vr">
								<div class="comment">
									<img src="/statics/assets/demo/avatars/5.jpg" alt="" class="comment-avatar">
								...
								<div class="comment">
									<img src="/statics/assets/demo/avatars/3.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="/statics/assets/demo/avatars/2.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="/statics/assets/demo/avatars/4.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
						...
						<div class="widget-threads panel-body tab-pane no-padding fade" id="dashboard-recent-threads">
							<div class="panel-padding no-padding-vr">
								<div class="thread">
									<img src="/statics/assets/demo/avatars/2.jpg" alt="" class="thread-avatar">
								...
								<div class="thread">
									<img src="/statics/assets/demo/avatars/3.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="/statics/assets/demo/avatars/4.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="/statics/assets/demo/avatars/5.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
					...
					<table class="table">
						...
						<tbody class="valign-middle">
							<tr>
								<td>1</td>
								<td>
									<img src="/statics/assets/demo/avatars/2.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@rjang</a>
								</td>
								<td>Robert Jang</td>
							...
							<tr>
								<td>2</td>
								<td>
									<img src="/statics/assets/demo/avatars/3.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@mbortz</a>
								</td>
							...
							<tr>
								<td>3</td>
								<td>
									<img src="/statics/assets/demo/avatars/4.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@towens</a>
								</td>
								<td>Timothy Owens</td>
							...
							<tr>
								<td>4</td>
								<td>
									<img src="/statics/assets/demo/avatars/5.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@dsteiner</a>
								</td>
...
<!--[if !IE]> -->
	<script type="text/javascript"> window.jQuery || document.write('<script src="/statics/assets/javascripts/jquery-1.8.3.min.js">'+"<"+"/script>"); </script>
<!-- <![endif]-->
<!--[if lte IE 9]>
	<script type="text/javascript"> window.jQuery || document.write('<script src="/statics/assets/javascripts/jquery-1.8.3.min.js">'+"<"+"/script>"); </script>
<![endif]-->
